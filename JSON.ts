namespace EisDealer {
    ...
    export const iceCreams: IceCream[] = [
        ...
        new IceCream("Schokolade", 1.5, "#84563C"),
        new IceCream("Zitrone", 1.5, "#fff700"),
        new IceCream("Waldmeister", 1.5, "#8B9916"),
        new IceCream("Erdbeere", 1.5, "#FB2943"),
        new IceCream("Joghurt", 1.5, "#F1F3F4"),
        new IceCream("Mango", 1.5, "#F4BB44"),
        new IceCream("Blaubeere", 1.5, "#4F86F7")
    ];
